...
void fillLocation_fuel(double2DVector& result, vector<Airstrip> airstrips, vector<Airplane> airplanes, double2DVector& from_to, map<unsigned int, Airstrip>& map_airstrip) {
