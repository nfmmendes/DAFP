...
void Passenger::print() {
	cout << "--" << name << " " << surname << " " << pnr << " " << code_flight << " " << pas_class << " " << gender << " dep: " << to_string(departure_location) << "-->" << departure_time << " arr: "
		<< to_string(arrival_location) << "-->" << arrival_time << " con il peso di: " << weight << " solution_from: " << solution_from << " solution_to: " << solution_to << " cap: " << capacity << 
		"del giorno: " << giorno << endl;
